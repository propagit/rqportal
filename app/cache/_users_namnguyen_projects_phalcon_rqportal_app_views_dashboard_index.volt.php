    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            ...
            <ul id="sparks" class="" ng-if="stats">
                ...
                <li class="sparks-info">
                    <a ng-if="stats.unallocated_quote > 0" href="<?php echo $baseUrl; ?>quote?q=un-allocated" class="badge bg-color-red">[[ stats.unallocated_quote ]]</a>

                    <h5> Quotes <span class="txt-color-purple"><i class="fa fa-comment-o"></i>&nbsp;[[ stats.total_quotes ]]</span></h5>
                </li>
                <li class="sparks-info">
                    <a ng-if="stats.incompleted_supplier > 0" href="<?php echo $baseUrl; ?>supplier" class="badge bg-color-red">[[ stats.incompleted_supplier ]]</a>
