...
<html <?php if ($this->router->getControllerName() != 'applicant') { ?> class="be"<?php } ?>>
    <head>
        ...
        <?php echo $this->tag->stylesheetLink('js/lib/angular-chart/angular-chart.css'); ?>
    ...
    <body ng-app="rqportal">
        ...
        <!-- SPARKLINES -->
        <?php echo $this->tag->javascriptInclude('js/lib/sparkline/jquery.sparkline.min.js'); ?>
        ...
        <!-- Chart -->
        <?php echo $this->tag->javascriptInclude('js/lib/chart/Chart.min.js'); ?>
        <?php echo $this->tag->javascriptInclude('js/lib/angular-chart/angular-chart.js'); ?>
        ...
        <?php echo $this->tag->javascriptInclude('js/controllers/dashboard.js'); ?>
        <?php echo $this->tag->javascriptInclude('js/controllers/applicant.js'); ?>
        <?php echo $this->tag->javascriptInclude('js/controllers/supplier.js'); ?>
